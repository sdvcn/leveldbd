...
enum CompressionEnum:int
{
    leveldb_no_compression = 0,
    leveldb_snappy_compression = 1
}

alias leveldb_no_compression = CompressionEnum.leveldb_no_compression;
alias leveldb_snappy_compression = CompressionEnum.leveldb_snappy_compression;

void leveldb_options_set_compression (leveldb_options_t*, CompressionEnum);
...
leveldb_filterpolicy_t* leveldb_filterpolicy_create (
    void* state,
    void function (void*) destructor,
    char* function (void*, const(char*)* key_array, const(size_t)* key_length_array, int num_keys, size_t* filter_length) create_filter,
    ubyte function (void*, const(char)* key, size_t length, const(char)* filter, size_t filter_length) key_may_match,
    const(char)* function (void*) name);
...
char* leveldb_env_get_test_directory (leveldb_env_t*);
